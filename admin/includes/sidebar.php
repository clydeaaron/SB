  <div class=" sidebar" role="navigation">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="add-services.php"><i class="fa fa-cogs nav_icon"></i>File Management<span class="fa arrow"></span> </a>
            ...
            <li class="">
              <a href="about-us.php"><i class="fa fa-book nav_icon"></i>Content Management <span class="fa arrow"></span></a>
              <ul class="nav nav-second-level collapse">
              <li>
                  <a href="edit-logo.php">Edit Logo</a>
                </li>
                <li>
                  <a href="add-doctors.php">Add Doctor's/Staff's</a>
                </li>
                <li>
